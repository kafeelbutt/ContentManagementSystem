    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">ArticleCMS</a>
        </div>
          ...
          <div class="col-md-9">
			...
			<?php 
             ...
             ?>
                      ...
                      <tr >
                        <td id="myarticle"><?php echo $row['Article_title'];?></td>
                        <td>
	
						<?php
						$visibility = $row['Artile_visibility'];
						
						if($visibility == 'Public')
						echo '<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>';
                        else
		echo '<span class="glyphicon glyphicon-remove" aria-hidden="false"></span>';					
						  ?>						
						</td>
                        <td><?php echo $row['Article_created_date'];?></td>
                        <td>
						<form method="post" action="article_view.php">
						<button class="btn btn-default" value="<?php echo $row['Article_id'];?> " name="edit" >Edit</button>
<button class="btn btn-danger" value="<?php echo $row['Article_id'];?> " name="delete" >Delete</button>						
...
if(isset($_POST['edit']))
{
	...
	echo "<script>window.open('article_edit.php','_self')</script>";
}
if(isset($_POST['delete']))
{
	$_SESSION['Article_id'] = $_POST['delete'];
$query = "delete from article where Article_id = '".$_SESSION['Article_id']."'";
$con->query($query);
echo "<script>window.open('article_view.php','_self')</script>";
}
?>